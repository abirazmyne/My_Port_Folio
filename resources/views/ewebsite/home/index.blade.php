...
<head>
    ...
    <title>Bangla Bazar </title>
    <meta name="description" content="">
    <meta name="viewport" content="">

    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}ewebsite/assets/img/banglabazar/titel-icon.png">

    <!-- CSS here -->
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/bootstrap.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/animate.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/swiper-bundle.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/slick.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/font-awesome-pro.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/flaticon_shofy.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/spacing.css">
    <link rel="stylesheet" href="{{asset('/')}}ewebsite/assets/css/main.css">
</head>
<body>
<!--[if lte IE 9]>
        ...
        <div id="loading-center-absolute">
            ...
            <div class="tp-preloader-content">
                <div class="tp-preloader-logo">
                    ...
                    <img src="{{asset('/')}}ewebsite/assets/img/banglabazar/titel-icon.png" height="100px" alt="logo">
                </div>
        ...
        <div class="offcanvas__content">
            <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                <div class="offcanvas__logo logo">
                    <a href="index.html">
                        <img src="{{asset('/')}}ewebsite/assets/img/logo/logome.png" height="90px" alt="logo">
                    </a>
                </div>
            </div>
            ...
            <div class="offcanvas__contact align-items-center d-none">
                <div class="offcanvas__contact-icon mr-20">
                     <span>
                        <img src="{{asset('/')}}ewebsite/assets/img/icon/contact.png" alt="">
                     </span>
                </div>
                ...
                <div class="offcanvas__select language">
                    <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                        <div class="offcanvas__lang-img mr-15">
                            <img src="{{asset('/')}}ewebsite/assets/img/icon/language-flag.png" alt="">
                        </div>
    ...
    <div class="cartmini__wrapper d-flex justify-content-between flex-column">
        <div class="cartmini__top-wrapper">
                ...
                <div class="cartmini__widget-item">
                    <div class="cartmini__thumb">
                        <a href="product-details.html">
                            <img src="{{asset('/')}}ewebsite/assets/img/product/product-1.jpg" alt="">
                        </a>
                    </div>
            ...
            <div class="cartmini__empty text-center d-none">
                <img src="{{asset('/')}}ewebsite/assets/img/product/cartmini/empty-cart.png" alt="">
    ...
    <div id="header-sticky" class="tp-header-area p-relative tp-header-sticky tp-header-height">
        ...
        <div class="tp-header-side-menu tp-side-menu-5">
            <nav  class="tp-category-menu-content">
                <ul>
                    <li class="has-dropdown">
                        <a href="index.html"><i class="flaticon-watermelon"></i>Home Demos</a>
                                        ...
                                        <div class="home-menu-item ">
                                            <a href="index.html">
                                                <div class="home-menu-thumb p-relative fix">
                                                    <img src="{{asset('/')}}ewebsite/assets/img/menu/menu-home-1.jpg" alt="">
                                                </div>
                            ...
                            <div class="mega-menu-left">
                                <div class="mega-menu-list">
                                    <ul>
                                        <li>
                                            <div class="mega-menu-img">
                                                <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-1.png" alt="">
                                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="mega-menu-img">
                                                <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-2.png" alt="">
                                            </div>
                                            <a href="shop.html" class="mega-menu-title">Fresh Fruits</a>
                                            <ul>
                                ...
                                <div class="mega-menu-brand">
                                    <a href="#">
                                        <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/menu-brand-1.png" alt="">
                                    </a>
                                    <a href="#">
                                        <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/menu-brand-2.png" alt="">
                                    </a>
                                    <a href="#">
                                        <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/menu-brand-3.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="mega-menu-right" data-bg-color="#F9F9F9">
                                ...
                                <div class="menu-shop-item d-flex align-items-center">
                                    <div class="menu-shop-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-3.png" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="menu-shop-item d-flex align-items-center">
                                    <div class="menu-shop-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-4.png" alt="">
                                        </a>
                                    </div>
                                    <div class="menu-shop-content">
                                        <div class="menu-shop-meta">
                                ...
                                <div class="menu-shop-item d-flex align-items-center">
                                    <div class="menu-shop-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-5.png" alt="">
                                        </a>
                                    </div>
                                    <div class="menu-shop-content">
                                        <div class="menu-shop-meta">
                                ...
                                <div class="menu-shop-item d-flex align-items-center">
                                    <div class="menu-shop-thumb">
                                        <a href="product-details.html">
                                            <img src="{{asset('/')}}ewebsite/assets/img/header/menu/grocery/img-6.png" alt="">
                                        </a>
                                    </div>
                                    <div class="menu-shop-content">
                                        <div class="menu-shop-meta">
...
<main>
                ...
                <div class="tp-slider-item-5 scene tp-slider-height-5 swiper-slide d-flex align-items-center" data-bg-color="#F3F3F3">
                    <div class="tp-slider-shape-5 ">
                        <div class="tp-slider-shape-5-1">
                            <img class="layer" data-depth=".2" src="{{asset('/')}}ewebsite/assets/img/slider/5/shape/shape-1.png" alt="">
                        </div>
                        <div class="tp-slider-shape-5-2">
                            <img class="layer" data-depth=".2" src="{{asset('/')}}ewebsite/assets/img/slider/5/shape/shape-2.png" alt="">
                        </div>
                        <div class="tp-slider-shape-5-3">
                            <img class="layer" data-depth=".2" src="{{asset('/')}}ewebsite/assets/img/slider/5/shape/shape-3.png" alt="">
                        </div>
                        <div class="tp-slider-shape-5-4">
                            <img class="layer" data-depth=".2" src="{{asset('/')}}ewebsite/assets/img/slider/5/shape/shape-4.png" alt="">
                        </div>
                    </div>
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-6">
                                <div class="tp-slider-thumb-wrapper-5 p-relative">
                                    <div class="tp-slider-thumb-shape-5 one d-none d-sm-block">
                                        <img data-depth="0.1" class="layer offer" src="{{asset('/')}}ewebsite/assets/img/slider/5/shape/offer.png" alt="">
                                    </div>
                                    <div class="tp-slider-thumb-5 main-img">
                                        <img data-depth="0.2" class="layer" src="{{asset('/')}}ewebsite/assets/img/slider/5/slider-1.png" alt="">
                            ...
                            <div class="swiper-wrapper">
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#E5EFE2">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-1.jpg"></div>
                                ...
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F5EFEC">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-2.jpg"></div>
                                        <div class="tp-category-content-5">
                                ...
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F2E0E3">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-3.jpg"></div>
                                        <div class="tp-category-content-5">
                                ...
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#E6F1E0">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-4.jpg"></div>
                                        <div class="tp-category-content-5">
                                ...
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F2E3D5">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-5.jpg"></div>
                                        <div class="tp-category-content-5">
                                ...
                                <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F6E9E8">
                                    <a href="shop-category.html" >
                                        <div class="tp-category-thumb-5 include-bg" data-background="{{asset('/')}}ewebsite/assets/img/category/5/category-6.jpg"></div>
                                        <div class="tp-category-content-5">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-1.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-2.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-3.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-4.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-5.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-6.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-7.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="tp-product-item-5 p-relative white-bg mb-40">
                                        <div class="tp-product-thumb-5 w-img fix mb-15">
                                            <a href="product-details.html">
                                                <img src="{{asset('/')}}ewebsite/assets/img/product/5/product-8.jpg" alt="">
                                            </a>
    ...
    <section class="tp-deal-area pt-135 pb-140 p-relative z-index-1 fix scene" data-bg-color="#F3F3F3">
        <div class="tp-deal-shape">
            <img class="tp-deal-shape-7" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-7.png" alt="">
        </div>
        <div class="tp-deal-shape">
            <div class="tp-deal-shape-1">
                <img class="layer" data-depth=".2" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-1.png" alt="">
            </div>
            <div class="tp-deal-shape-2">
                <img class="layer" data-depth=".3" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-2.png" alt="">
            </div>
            <div class="tp-deal-shape-3">
                <img class="layer" data-depth=".4" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-3.png" alt="">
            </div>
            <div class="tp-deal-shape-4">
                <img class="layer" data-depth=".5" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-4.png" alt="">
            </div>
            <div class="tp-deal-shape-5">
                <img class="layer" data-depth=".6" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-5.png" alt="">
            </div>
            <div class="tp-deal-shape-6">
                <img class="layer" data-depth=".7" src="{{asset('/')}}ewebsite/assets/img/deal/shape/shape-6.png" alt="">
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="tp-product-sm-item-wrapper-5 is-translate-24">
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-1.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-product-sm-content-5">
                                    <div class="tp-product-sm-tag-5">
                            ...
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-product-sm-content-5">
                                    <div class="tp-product-sm-tag-5">
                    ...
                    <div class="tp-product-sm-wrapper-5 mb-60">
                        ...
                        <div class="tp-product-sm-item-wrapper-5">
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-product-sm-content-5">
                                    <div class="tp-product-sm-tag-5">
                            ...
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-5.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-product-sm-content-5">
                                    <div class="tp-product-sm-tag-5">
                            ...
                            <div class="tp-product-sm-item-5 d-flex align-items-center">
                                <div class="tp-product-sm-thumb-5 fix">
                                    <a href="product-details.html">
                                        <img src="{{asset('/')}}ewebsite/assets/img/product/sm/5/product-sm-6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="tp-product-sm-content-5">
                                    <div class="tp-product-sm-tag-5">
                                    ...
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                       ...
                                       <span>
                                        ...
                                        <div class="tp-footer-contact-content">
                                            <p><a href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#a5d6cdcac3dce5c2c8c4ccc98bc6cac8"><span class="__cf_email__" data-cfemail="7003181f160930171d11191c5e131f1d">[email&#160;protected]</span></a></p>
                                        </div>
                                    </div>
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        <div class="tp-footer-contact-icon">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="tp-footer-payment text-md-end">
                                <p>
                                    <img src="{{asset('/')}}ewebsite/assets/img/footer/footer-pay-2.png" alt="">
                                </p>
                            </div>
                        </div>
                    </div>
...
</script><script src="{{asset('/')}}ewebsite/assets/js/vendor/jquery.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/vendor/waypoints.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/bootstrap-bundle.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/meanmenu.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/swiper-bundle.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/slick.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/range-slider.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/magnific-popup.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/nice-select.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/purecounter.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/parallax.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/countdown.js"></script>

<script src="{{asset('/')}}ewebsite/assets/js/isotope-pkgd.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/imagesloaded-pkgd.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/ajax-form.js"></script>
<script src="{{asset('/')}}ewebsite/assets/js/main.js"></script>
</body>
